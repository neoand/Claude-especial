...
Este é um **template genérico** do Claude-especial. Os styles incluídos são **exemplos** que você deve adaptar:

- **odoo-expert.md** → Adapte para seu framework (Django, React, etc.)
- **performance-guru.md** → Use como está (genérico)
- **architect.md** → Use como está (genérico)

**Como adaptar:**
1. Copie o style example
2. Substitua domínio específico pelo seu
3. Mantenha a estrutura e formato
4. Adicione checklist específico do seu domínio
...
> **Nota:** Os styles incluídos são **exemplos**. Adapte para seu domínio específico!

### 1. 🐍 domain-expert (exemplo: odoo-expert)

**Ativar com:** `@domain-expert` ou referência a arquivo `.claude/output-styles/domain-expert.md`

**Quando usar:**
- Desenvolver código específico do seu domínio
- Debugar problemas técnicos
- Code review especializado
- Otimizar queries e models
- Questões específicas do framework/tecnologia

**Características:**
- Expertise profunda no domínio
- SEMPRE verifica padrões corretos
- SEMPRE considera security/performance
- SEMPRE sugere bibliotecas/módulos apropriados
- Output técnico e preciso

**Exemplo incluído:** `odoo-expert.md` (Odoo 15 specialist)
- Adapte para seu domínio: Django, React, Kubernetes, etc.
